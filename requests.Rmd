...
-   Admin
    ...
    <input type="checkbox"> Have you updated the relevant quality assurance logs?

          - Links to QA logs - more info on how to fill out
          
          - Note any new data uploaded to S3 should be logged in our [S3 Data Log] and the information can then be copied across to the QA log data tab.
